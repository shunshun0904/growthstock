...
- 第4・5章（マクロ）は優先度を下げる
- 第2・3章は「ほぼ全部網羅したい」→ ○ の項目は J-Quants の取得済み項目から特徴量にした
  （`features.GROUPS["fund_book"]`、12指標 × 水準・直近の変化・その前の変化 = 27列。実験56 で判定）
- △ の年次明細（売上総利益・研究開発費・設備投資・減価償却・有利子負債・流動/固定の内訳・利益剰余金・

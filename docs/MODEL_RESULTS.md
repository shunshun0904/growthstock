...
| --- | ---: | ---: | ---: | ---: | ---: |
| LightGBM [all] | 0.1775 | 0.5621 | 11.1% | 17.8% | 1.19x |
...
| --- | ---: | ---: | :---: | ---: | --- |
| LightGBM [all] | 0.1775 | +0.0277 | [+0.0131, +0.0499] | 1.000 | 有意 |
...
| --- | ---: | --- | ---: | ---: |
| `all` | 136 | fund_level + fund_lag + fund_trend + fund_streak + price + breakout + volume + liquidity + supply + progress + valuation + dividend + cashflow + efficiency + guidance + sector + turnaround + market | 0.1775 | 1.19x |

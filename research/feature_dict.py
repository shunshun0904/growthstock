...
COL_JA = {
    ...
    "jq_fwdper": "予想EPS で割った PER（倍）。実績 PER より先を見ている",
    "jq_fwdroe": "予想ROE（%）",
    "jq_fwd_earnings_yield": "予想PER の逆数（%）。PER が発散しても安定する",
    "jq_roe_gap": "予想ROE − 実績ROE（pt）。会社が改善を見込んでいるか",
    "jq_per_gap": "実績PER − 予想PER（倍）。利益成長が織り込まれている度合い",

    # --- 株主構成: 大量保有報告書（EDINET）------------------------------ #
    "lvs_days": "直近の大量保有報告書の提出から何日経ったか",
    "lvs_ratio": "直近の報告書が示す保有割合（%）",
    "lvs_ratio_chg": "前回の報告書からの保有割合の変化（pt）。買い増しか売り抜けか",
    "lvs_n_20": "直近20営業日の提出件数。短期に集まると動きがある",
    "lvs_n_60": "直近60営業日の提出件数",
    "lvs_n_250": "直近250営業日（約1年）の提出件数",
    ...
    "mjr_n": "開示されている大株主の人数",
    "mjr_conc": "上位10名の集中度。top10 ÷ 人数",
    "mjr_trust": "大株主のうち信託銀行らしい先の保有割合（%）。機関投資家の代理",
    "mjr_indiv": "大株主のうち法人らしくない先の保有割合（%）。個人・創業家の代理",

    # --- 株主構成: 政策保有株（EDINET、年1回）-------------------------- #
    "xh_days": "直近の政策保有株の開示から何日経ったか",
    "xh_iss": "政策保有している銘柄数",
    "xh_bookval": "政策保有株の貸借対照表計上額（円）",
    "xh_dec_amt": "当期に減らした金額（円）。持ち合い解消",
    "xh_inc_cost": "当期に増やした取得原価（円）",
    ...
    "alert_longoutratio": "買残の対上場株式数比率（%）",
    "alert_shrtoutratio": "売残の対上場株式数比率（%）",
    "alert_slratio": "売残 ÷ 買残。踏み上げの余地",

    # --- 次の決算まで（/fins/earnings-date）---------------------------- #
    "days_to_earn": "次の決算発表予定日まで何日か。**公表済みの予定だけ**を使う",

    # --- 市場全体の需給（/markets/short-ratio, /equities/investor-types）- #
    "short_ratio": "その銘柄が属する業種の空売り比率（%）",
    "short_ratio_20": "同じものの20営業日平均",
    "inv_foreign": "投資部門別売買の外国人の売買差（買い越しが正）",
    "inv_foreign_4w": "同じものの4週合計",
    "inv_trust": "投資信託の売買差",
    "inv_trust_4w": "同じものの4週合計",
    "inv_indiv": "個人の売買差",
    "inv_indiv_4w": "同じものの4週合計",
    "inv_prop": "証券会社の自己売買の差",
    "inv_prop_4w": "同じものの4週合計",
    "inv_busco": "事業法人の売買差。自社株買いを含む",
    "inv_busco_4w": "同じものの4週合計",

    # --- 予想の修正イベント（fins の DocType から作る）------------------ #
    "days_since_rev": "直近の業績予想の修正から何日経ったか",
    "rev_pct": "直近の修正の幅（%）。上方修正なら正",
    "rev_up": "直近の修正が上方なら1、下方なら0",
    "rev_n_60": "直近60営業日の修正回数",
    "rev_n_250": "直近250営業日（約1年）の修正回数。修正が多い会社ほど見通しが動く",
    "rev_up_n_250": "直近250営業日の上方修正の回数",
    "rev_dn_n_250": "直近250営業日の下方修正の回数",

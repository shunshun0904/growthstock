...
#: 市場区分。2022-04 の再編前（101〜107）と後（111〜113）が混在する
MKT_JA = {101: "東証一部(〜2022/4)", 102: "東証二部(〜2022/4)", 104: "マザーズ(〜2022/4)",
          105: "TOKYO PRO", 106: "JASDAQ スタンダード(〜2022/4)",
          107: "JASDAQ グロース(〜2022/4)", 109: "その他(ETF)",
